...
namespace FKAttendDllCSSample
{
	...
	public class frmMain : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.cmdHolidayInfo = new System.Windows.Forms.Button();
            ...
            this.cmdNetInfo.Location = new System.Drawing.Point(284, 549);
            ...
            this.cmdSetAdjustInfo.Location = new System.Drawing.Point(284, 503);
            ...
            this.cmdBellInfo.Location = new System.Drawing.Point(284, 368);
            ...
            this.cmdProuctData.Location = new System.Drawing.Point(284, 324);
            ...
            this.cmdLogData.Location = new System.Drawing.Point(284, 234);
            ...
            this.txtMachineNumber.Location = new System.Drawing.Point(207, 98);
            ...
            this.txtMachineNumber.Size = new System.Drawing.Size(42, 26);
            ...
            this.txtIPAddress.Text = "192.168.0.9";
            // 
            // lblPassword
            // 
            ...
            this.lblComLicense.Location = new System.Drawing.Point(316, 101);
            ...
            this.cmdSetPassTime.Location = new System.Drawing.Point(284, 458);
            ...
            this.cmdSystemInfo.Location = new System.Drawing.Point(284, 279);
            ...
            this.cmdUserInfo.Location = new System.Drawing.Point(284, 414);
            ...
            this.txtLicense.Location = new System.Drawing.Point(383, 98);
            this.txtLicense.MaxLength = 0;
            this.txtLicense.Name = "txtLicense";
            this.txtLicense.RightToLeft = System.Windows.Forms.RightToLeft.No;
            this.txtLicense.Size = new System.Drawing.Size(54, 26);
            ...
            this.lblMachineNumber.Location = new System.Drawing.Point(71, 101);
            ...
            this.lblVer.Text = "FKAttend.dll (v2. 8. 14. 2)";
            ...
            this.lbSubject.Text = "FKAttend.DLL C# Sample (v2.3.8.10)";
            this.lbSubject.TextAlign = System.Drawing.ContentAlignment.TopCenter;
            // 
            // cmdHolidayInfo
            // 
            this.cmdHolidayInfo.BackColor = System.Drawing.SystemColors.Control;
            this.cmdHolidayInfo.Cursor = System.Windows.Forms.Cursors.Default;
            this.cmdHolidayInfo.Font = new System.Drawing.Font("Times New Roman", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.cmdHolidayInfo.ForeColor = System.Drawing.SystemColors.ControlText;
            this.cmdHolidayInfo.Location = new System.Drawing.Point(284, 594);
            this.cmdHolidayInfo.Name = "cmdHolidayInfo";
            this.cmdHolidayInfo.RightToLeft = System.Windows.Forms.RightToLeft.No;
            this.cmdHolidayInfo.Size = new System.Drawing.Size(228, 37);
            this.cmdHolidayInfo.TabIndex = 91;
            this.cmdHolidayInfo.Text = "Set Holiday Info";
            this.cmdHolidayInfo.UseVisualStyleBackColor = false;
            this.cmdHolidayInfo.Click += new System.EventHandler(this.cmdHolidayInfo_Click);
            // 
            // frmMain
            // 
            ...
            this.Controls.Add(this.cmdHolidayInfo);
        ...
        [DllImport("FKAttend.dll", CharSet = CharSet.Ansi)]
        public static extern int FK_GetEncrptEnrolledData(
            int anHandleIndex,
            int apnBackupNumber,
            byte[] apnEnrollData,
            int anPassword,
        ...
        //{ Access Control
        [DllImport("FKAttend.dll", CharSet = CharSet.Ansi)]
        public static extern int FK_GetDoorOpenStatus(int anHandleIndex, ref int apnStatusVal);
        ...
        [DllImport("FKAttend.dll", CharSet = CharSet.Ansi)]
        public static extern int FK_EmptyHolidayLogData(int anHandleIndex);

        [DllImport("FKAttend.dll", CharSet = CharSet.Ansi)]
        public static extern int FK_LoadHolidayLogData(int anHandleIndex, int anReadMark);
        ...
        */
        [DllImport("FKAttend.dll", CharSet = CharSet.Ansi)]
        public static extern int FK_GetHolidayLogData(
            int anHandleIndex,
            ref int apnEnrollNumber,
            ref int apnVerifyMode,
            ref int apnInOutMode,
            ref DateTime apnDateTime,
             [MarshalAs(UnmanagedType.LPStr)] ref string apstrHolidayName,
            ref int apnDoorOpen);
        [DllImport("FKAttend.dll", CharSet = CharSet.Ansi)]
        public static extern int FK_GetHolidayInfo(
            int anHandleIndex,
            byte[] apnHolidayInfo,
            int anHolidaySize);

        [DllImport("FKAttend.dll", CharSet = CharSet.Ansi)]
        public static extern int FK_SetHolidayInfo(
            int anHandleIndex,
            byte[] apnHolidayInfo,
            int anHolidaySize);
        ...
        public static int ConvertNumer(string str)
        {
            int vValue;
            try
            {
                vValue = Convert.ToInt32(str);
            }
            catch
            {
                return 0;
        ...
        public static String GetStringVerifyMode(UInt32 nVerifyMode)
        {
            String vRet = "";
            int vByteCount = 4;
		...
		private void enableButtons(bool abEnableFlag)
		{
            ...
            cmdHolidayInfo.Enabled = abEnableFlag;
        ...
        private void cmdHolidayInfo_Click(object sender, EventArgs e)
        {
            showChildForm(new frmHolidayInfo());
        }
